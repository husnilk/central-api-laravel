...
class AuthController extends Controller
{
    public function login(LoginRequest $request)
    {
        ...
        if ($remember_me) {
            ...
            $accessToken = $user->createToken('access_token', ['*'], Carbon::now()->addHours(2));
            $refreshToken = $user->createToken('refresh_token', ['*'], Carbon::now()->addHours(2));
        }
        ...
        $data = [
            'authorization' => [
                ...
                'type' => 'Bearer',
                'expires_at' => strtotime($accessToken->accessToken->expires_at) * 1000,
            ],
            'profile' => $profile,
